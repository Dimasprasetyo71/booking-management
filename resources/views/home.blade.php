...
<div class="hero-wrap js-fullheight" style="background-image: url({{ asset('assets/images/image_2.jpg') }}); margin-top: -25px;" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-services">
    	<div class="container">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url({{asset('assets/images/image_3.jpg')}});"></div>
              <div class="media-body py-4 px-3">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url({{asset('assets/images/image_5.jpg')}});"></div>
              <div class="media-body py-4 px-3">
    ...
    <section class="ftco-section bg-light">
		...
		<section class="ftco-intro" style="background-image: url(images/image_2.jpg);" data-stellar-background-ratio="0.5">			<div class="overlay"></div>
			<div class="container">
				<div class="row justify-content-center">
